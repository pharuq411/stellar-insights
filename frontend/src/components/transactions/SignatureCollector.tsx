          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <CardDescription className="text-slate-400">
                Collect {requiredSignatures} signatures to authorize this
                transaction
              </CardDescription>
            </div>
          </div>
          ...
          <div className="space-y-4 pt-4 border-t border-slate-800">
            <div className="flex items-center justify-between mb-2">
              <Label className="text-slate-300">
                Progress: {signatures.length} / {requiredSignatures} Signatures
              </Label>
            ...
            <div className="space-y-2 mt-4">
              {signatures.map((sig, i) => (
                <div
                  key={i}
                  className="flex items-center justify-between p-3 rounded-md bg-slate-800/50 border border-slate-700/50"
                >
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-emerald-400" />
                    <span className="text-sm font-medium text-slate-300">
                      {sig.signer.substring(0, 6)}...
                      {sig.signer.substring(sig.signer.length - 4)}
                    </span>
                  </div>
